               ...
               <div class="col-sm-3">
                ...
                <div class="col-sm-9">
                  ...
                  <ul class="list-group ticketView">
                      ...
                      <li class="list-group-item ticketView">
                          <button type="button" id="32_bit_Windows" class="btn btn-primary achat">32 bits</button>
                          <button type="button" id="64_bit_Windows" class="btn btn-primary achat">64 bits</button>
                      </li>
                  </ul>
               ...
               <div class="col-sm-3">
                ...
                <div class="col-sm-9">
                 ...
                 <ul class="list-group ticketView">
                      ...
                      <li class="list-group-item ticketView">
                          <button type="button"  id="32_bit_Mac" class="btn btn-primary achat">32 bits</button>
                          <button type="button"  id="64_bit_Mac" class="btn btn-primary achat">64 bits</button>
                      </li>
                  </ul>
               ...
               <div class="col-sm-3">
                ...
                <div class="col-sm-9">
                  ...
                  <ul class="list-group ticketView">
                      ...
                      <li class="list-group-item ticketView">
                          <button type="button" id="32_bit_Ubuntu" class="btn btn-primary achat">32 bits</button>
                          <button type="button" id="64_bit_Ubuntu" class="btn btn-primary achat">64 bits</button>
                      </li>
                  </ul>
